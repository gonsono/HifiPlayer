...
class Display:
    ...
    def __init__(self, mode=default_mode, LCD_CS=LCD_CS, LCD_RST=LCD_RST, LCD_A0=LCD_A0, LCD_CLK=LCD_CLK, LCD_SI=LCD_SI):
        ...
        self.bmp_radio = RADIO
        self.bmp_spotify = SPOTIFY
        self.bmp_volume = VOLUME
    ...
    def lcd_progress(self, x_pos, y_pos, char):
        ...
        for i in range(0, 2):
            self.lcd_tranfer_data(PROGRESS[char][i], 1)
...
PROGRESS=(
(0xFC, 0x0C, 0x3F, 0x30), # Opening bracket
(0xE0, 0xE0, 0x07, 0x07), # Progress
(0x0C, 0xFC, 0x30, 0x3F), # Opening bracket
